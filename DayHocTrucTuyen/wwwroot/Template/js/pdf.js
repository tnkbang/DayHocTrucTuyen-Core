(function (root, factory) {
    ...
    */
    ...
    let embed = function (url, targetSelector, options) {
        ...
        let fallbackHTML = "";
        let pdfOpenFragment = "";
        let fallbackHTML_default = "<p>Trình duyệt của bạn không hỗ trợ xem PDF nội tuyến. Vui lòng tải xuống <a href='[url]'>tại đây</a>.</p>";

        //Ensure URL is available. If not, exit now.
        if (typeof url !== "string") { return embedError("Không tìm thấy file", suppressConsole); }

        //If target element is specified but is not valid, exit without doing anything
        if (!targetNode) { return embedError("Không thể xác định file", suppressConsole); }
        ...
        return embedError("Trình duyệt của bạn không hỗ trợ nhúng PDF", suppressConsole);
